/**
 * Prediction Engine for ACNH Stalk Market Predictions
 *
 * @name google-sheets-stalk-market-calculator
 * @version 1.1.0
 *
 * Engine below lifted wholesale from Mike Bryant's excellent webapp translation of Treeki's reverse engineering of the Animal Crossing source code
